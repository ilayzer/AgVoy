 ...
 */
final class Version20191125122642 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE unavailability (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, room_id INTEGER NOT NULL, starting_on DATE NOT NULL, ending_on DATE NOT NULL)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__booking AS SELECT id, client_id, room_id, starting_on, ending_on, price, confirmed FROM booking');
        ...
        $this->addSql('INSERT INTO booking (id, client_id, room_id, starting_on, ending_on, price, confirmed) SELECT id, client_id, room_id, starting_on, ending_on, price, confirmed FROM __temp__booking');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__booking AS SELECT id, client_id, room_id, starting_on, ending_on, price, confirmed FROM booking');
        $this->addSql('DROP TABLE booking');
        $this->addSql('CREATE TABLE booking (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, client_id INTEGER NOT NULL, room_id INTEGER NOT NULL, starting_on DATE NOT NULL, ending_on DATE NOT NULL, price DOUBLE PRECISION NOT NULL, confirmed BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO booking (id, client_id, room_id, starting_on, ending_on, price, confirmed) SELECT id, client_id, room_id, starting_on, ending_on, price, confirmed FROM __temp__booking');
        $this->addSql('DROP TABLE __temp__booking');
        $this->addSql('CREATE INDEX IDX_E00CEDDE19EB6921 ON booking (client_id)');
        $this->addSql('CREATE INDEX IDX_E00CEDDE54177093 ON booking (room_id)');
